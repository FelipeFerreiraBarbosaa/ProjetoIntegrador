...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void btLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLoginActionPerformed
        ...
        if (login == true) {
            //Coloca na variável global User_data o nome do usuario logado, para logs e auditorias
            org.apache.log4j.MDC.put("User_data", atual.getUsuario());
            log.info("Login realizado com exito - usuario: " + atual.getUsuario());
            Menu tela = new Menu(atual);
