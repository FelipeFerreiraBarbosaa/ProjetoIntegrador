...
public class TableModelCliente extends AbstractTableModel {
    ...
    private static final int emailCliente = 1;
    private static final int TelefoneCliente = 2;
    private static final int criacaoCliente = 3;
    private static final int atualizacaoCliente = 4;
    private static final int CpfCliente = 5;
    ...
    public TableModelCliente() {
        ...
        colunas = new String[]{"Cliente", "E-mail", "Telefone", "Criação", "Atualização","CPF"};
    }
