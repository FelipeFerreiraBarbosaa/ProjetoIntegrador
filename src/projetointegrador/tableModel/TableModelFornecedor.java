...
public class TableModelFornecedor extends AbstractTableModel {
    ...
    private static final int cnpjFornecedor = 1;
    ...
    public TableModelFornecedor() {
        ...
        colunas = new String[]{"Fornecedor", "Cnpj" , "E-mail", "Telefone", "Criação", "Atualização"};
    }
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case nomeFornecedor:
                ...
                break;
            case cnpjFornecedor:
                fornecedor.setCnpjFornecedor((String) aValue);
                break;
            case emailFornecedor:
